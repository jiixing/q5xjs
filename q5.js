            ...
            if ($._style.colorMode == $.RGB) {
                if (arguments.length == 1) {
                    if (typeof arguments[0] === 'string') {
                        let parseResults = _checkHexStrings(arguments[0])
                        if (parseResults)
                            return new $.Color(parseResults[0], parseResults[1], parseResults[2], parseResults[3])
                    }
